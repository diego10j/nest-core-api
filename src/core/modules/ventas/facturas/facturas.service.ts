    ...
    async getProformaParaFactura(dtoIn: HeaderParamsDto, numeroProforma: string) {
        ...
        const qDet = new SelectQuery(`
            SELECT
                ...
                d.descuento_ccdpr AS descuento,
                d.porcentaje_descuento_ccdpr AS porcentaje_descuento,
        ...
        const detallesResponse = detalles.map((d: any) => ({
            ...
            descuento_ccdfa: Number(d.descuento ?? 0),
            porcentaje_descuento_ccdfa: Number(d.porcentaje_descuento ?? 0),

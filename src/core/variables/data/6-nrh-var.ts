...
export const NOMINA_VARS = [
  ...
  // NOTA: las 9 cuentas contables de la provisión de décimos/fondos de reserva
  // (pasivo/gasto-venta/gasto-admin × fondos_reserva/decimo_tercero/decimo_cuarto)
  // vivían acá como variables sueltas hasta 2026-08-30. Se movieron a
  // nrh_rubro_cuenta.ide_cndpc_pasivo/ide_cndpc_gasto_venta/ide_cndpc_gasto_admin
  // (Nómina > Catálogos > Cuenta Contable de Rubros) — ver docs/modulo-nomina.md,
  // sección 6.1, y scripts/core/modules/nomina/09-script-cuentas-provision-rubro-cuenta.sql.
  // Las filas correspondientes en sis_parametros se eliminaron.
  {
    ide_modu: MODULOS.NOMINA.ID,

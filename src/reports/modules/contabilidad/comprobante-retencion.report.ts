        ...
        columns: [
            { text: '', width: '*' },
            {
                ...
                table: {
                    ...
                    body: [
                        [
                            { text: 'TOTAL RETENIDO', style: 'totalGrandLabel', fillColor: RIDE_COLOR.grisTh, border: [false, false, false, false] as [boolean, boolean, boolean, boolean] },
                            { text: fCurrency(total), style: 'totalGrandValor', fillColor: RIDE_COLOR.grisTh, border: [false, false, false, false] as [boolean, boolean, boolean, boolean] },
                        ],
                    ],
                },
                layout: {

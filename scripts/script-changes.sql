...
CREATE TABLE inv_lote (
	...
	archivo1_inlot varchar(120),
	archivo2_inlot varchar(120),
	nom_archivo2_inlot varchar(200),
	archivo3_inlot varchar(120),
	nom_archivo3_inlot varchar(200),
...
-- Reporte de Envío de Facturas: liga la factura por pagar (flete) generada desde el XML del transportista
ALTER TABLE public.cxc_transporte_factura ADD COLUMN ide_cpcfa int4;
ALTER TABLE public.cxc_transporte_factura ADD CONSTRAINT fk_cxc_transporte_factura_cpcfa FOREIGN KEY (ide_cpcfa) REFERENCES public.cxp_cabece_factur(ide_cpcfa);